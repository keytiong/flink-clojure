...
public class CljKeyedBroadcastProcessFunction<KS, IN1, IN2, OUT> extends KeyedBroadcastProcessFunction<KS, IN1, IN2, OUT>
    ...
    public CljKeyedBroadcastProcessFunction(APersistentMap args) {
    ...
    @Override
    public void processElement(IN1 value, KeyedBroadcastProcessFunction<KS, IN1, IN2, OUT>.ReadOnlyContext ctx, Collector<OUT> out) throws Exception {
        processElementFn.invoke(this, value, ctx, out);
    }

    @Override
    public void processBroadcastElement(IN2 value, KeyedBroadcastProcessFunction<KS, IN1, IN2, OUT>.Context ctx, Collector<OUT> out) throws Exception {
